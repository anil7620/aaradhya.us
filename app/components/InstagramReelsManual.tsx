...
/**
 * Manual Instagram Reels Component
 * 
 * Use this component if you prefer to manually embed specific reels.
 * To get embed code:
 * 1. Go to Instagram.com
 * 2. Open the reel you want to embed
 * 3. Click three dots (...) → Embed
 * 4. Copy the embed code
 * 5. Extract the reel ID from the URL or use the full embed code
 */

interface ManualReel {
  reelId: string // Shortcode from Instagram URL (e.g., "C1234567890" from instagram.com/reel/C1234567890/)
  caption?: string
}

interface InstagramReelsManualProps {
  username?: string
  reels?: ManualReel[]
}
  ...
  return (
    <div className="py-16 px-4 bg-gray-50">
          ...
          {reels.map((reel) => (
            ...
            >
              <blockquote
                ...
                data-instgrm-permalink={`https://www.instagram.com/reel/${reel.reelId}/`}
      ...
      <Script
        ...
        strategy="lazyOnload"
        onLoad={() => {
          // Instagram embed script loads and processes embeds
          if (window.instgrm) {
